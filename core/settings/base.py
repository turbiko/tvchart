"""
Django settings for tvchart core project.
...
INSTALLED_APPS = [
    ...
    "wagtail.contrib.modeladmin",  # added for django model to wagtail adminpanel
    "wagtail.embeds",
    "wagtail.sites",
    "wagtail.users",
    "wagtail.snippets",
...
# WAGTAILADMIN_BASE_URL = "http://otv.argentum.ua"
